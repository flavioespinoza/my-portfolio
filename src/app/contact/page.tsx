    ...
    <main className="max-w-xl mx-auto p-6 space-y-6">
      ...
      <div className="space-y-2 text-sm">
        ...
        <p className="flex items-center gap-2">
          ...
          <a href="https://github.com/flavioespinoza" className="underline" target="_blank" rel="noreferrer">
            github.com/flavioespinoza
          </a>
        </p>
        <p className="flex items-center gap-2">
          <Linkedin className="h-4 w-4" />
          <a href="https://www.linkedin.com/in/flavioespinoza" className="underline" target="_blank" rel="noreferrer">
